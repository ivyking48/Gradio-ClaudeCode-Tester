"""BUG VARIANT A: Zoom slider is shown in UI but NOT passed to ffmpeg export.
Export always uses zoom=1.0 regardless of slider value.
The CSS preview correctly shows zoom, making this harder to catch."""
...
def export_video(trim_start, trim_end, zoom, pan_x, pan_y):
    ...
    # BUG: zoom is received but ignored — always 1.0
    zoom = 1.0
